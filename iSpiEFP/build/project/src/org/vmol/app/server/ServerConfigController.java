...
import org.vmol.app.server.ServerDetails.QueueOptions;
import org.vmol.app.server.view.ServerEditViewController;
...
public class ServerConfigController implements Initializable{
	...
	@FXML
	private TableColumn<ServerDetails, String> userName;
	...
	public void initialize(URL location, ResourceBundle resources) {
		cid.setCellValueFactory(new Callback<CellDataFeatures<ServerDetails, String>, ObservableValue<String>>() {
            @Override public ObservableValue<String> call(CellDataFeatures<ServerDetails, String> c) {
        ...
        userName.setCellValueFactory(new PropertyValueFactory<ServerDetails, String>("userName"));
