...
//	}
	...
	private void automatic_fragmentation() {
		String pdb_file = MainViewController.getLastOpenedFile();
		
	}
	
	public void show(File xyzFile) throws IOException, UnrecognizedAtomException {
        if (jmolWindow == null) {
        	System.out.println("ya it is null");
            ...
            if (selection_mode == true) {
            	System.out.println("Selection mode is true");
            ...
            JMenuItem search_frag = new JMenuItem(new AbstractAction("Search Fragment Parameters") {
            	public void actionPerformed(ActionEvent e) {
            		if (picking_mode == 1) {
    	    			...
    	    			try {
							ArrayList atom_details = PDBParser.get_atoms(xyzFile);
...
//									Atom current_atom = (Atom) atom_details.get((Integer) groups.get(i).get(j));
...
//                				controller = new QChemInputController("", null);
//                				loader.setController(controller);
//                				Platform.runLater(new Runnable(){
//                					@Override
//                					public void run() {
...
//            		}
    	    ...
    	    JMenuItem submit_gamess = new JMenuItem(new AbstractAction("Gamess Submission") {
    	    	public void actionPerformed(ActionEvent e) {
    				...
    				controller = new gamessInputController(xyzFile,groups,null);
    				loader.setController(controller);
    				Platform.runLater(new Runnable(){
    					@Override
    					public void run() {
