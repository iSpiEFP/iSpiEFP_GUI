...
public class OutputFile {
    ...
    public void parseEnergyMinimizationJob(BufferedReader br, String currentLine) throws IOException {
        do {
            if (currentLine.equals("")) continue;
            String keyword = currentLine.split(" ")[0];
    ...
    public void parseSinglePointEnergyJob(BufferedReader br, String currentLine) throws IOException {
        do {
            if (currentLine.equals("")) continue;
            String keyword = currentLine.split(" ")[0];
            State initialState = new State();
