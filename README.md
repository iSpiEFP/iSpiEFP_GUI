...
9. **Compiler Output** - To specify where IntelliJ should direct compiler output to, in the Project explorer sidebar, right click on the "iSpiEFP/out" folder and select "Copy path." Then, go to "File > Project Structure," and under the "Project compiler output" section, paste the filepath that was copied (ctrl+v).
